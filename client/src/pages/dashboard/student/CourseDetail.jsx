...
const CourseDetail = () => {
    ...
    useEffect(() => {
        const loadCourse = async () => {
            try {
                ...
                if (firstModuleWithLessons && !activeLesson) {
    ...
    const handleToggleProgress = async (lessonId, currentStatus) => {
        ...
        try {
            ...
            setCourseDetails(prev => ({ ...prev, [courseId]: updatedCourse }));
            invalidateCache('stats'); // Stats contain progress percentage
    ...
    return (
        <div className="flex flex-1 h-full bg-bg-main overflow-hidden">
            ...
            <main className="flex-1 p-8 overflow-y-auto w-full">
                {loading ? (
                    <Loading text="Preparing your lesson..." />
                ) : !course ? (
